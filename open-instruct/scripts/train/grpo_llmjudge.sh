...
EVALS="ifeval::hamish_zs_reasoning_deepseek,bbh:cot::hamish_zs_reasoning_deepseek_v2,gpqa:0shot_cot::hamish_zs_reasoning_deepseek,minerva_math::hamish_zs_reasoning_deepseek,minerva_math_500::hamish_zs_reasoning_deepseek"

JUDGE_BASE_URL=http://saturn-cs-aus-238.reviz.ai2.in:8001/v1

EXP_NAME="grpo_general_judge_think_4b"
...
python open_instruct/grpo_fast.py \
    ...
    --llm_judge_max_context_length 25000 \
